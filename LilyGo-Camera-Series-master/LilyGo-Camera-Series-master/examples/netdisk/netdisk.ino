...
const char *secretKey = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
const char *appName = "xxxxxxxxxxxx";

const char *scope = "basic,netdisk";
...
void capture(void)
{
    ...
    if (fb->format == PIXFORMAT_JPEG) {
        fb_len = fb->len;
        xpan.upload(fb->buf, fb_len, 60, "capture.jpg");
    }
